...
export function App() {
  ...
  const localStorageTaks = JSON.parse(localStorage.getItem('saveTasks'))
  const tasks = localStorage.getItem('tasks') !== null ? localStorageTaks : []
  ...
  return (
    <div>
      ...
      <div className={styles.wrapper}>
        ...
        />
        <button onClick={() => recuperarDados(key)}>Recuperar dados</button>
      </div>
    </div>
  )
}
